...
function load(){	//页面加载
	...
	for(j = 0; j < tree.length; j++) {
		...
		$("#sidebar_left").tabs("add",{title:title,content:"<div id="+id+" class='menudiv'></div><div id="+id+"content class='menustyle'></div>"}); /**<div id="+id+"content class='menustyle'></div>*/
