...
<html>
	<head>
		 ...
		 <script type="text/javascript" src="${ctxPath}/module/bsf/defaultGrid/default.js?v=<%=com.youlun.baseframework.util.AppUtils.getResLastTimeStr("/module/bsf/defaultGrid/default.js")%>"></script>
		 <title></title>
	</head>
	<body>
		 <div id="cc" class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'west',split:true" title="查询面板" style="width:350px;">
				<div id="queryPanel" class="easyui-panel" data-options="fit:true" style="margin:0;padding-top:400;text-align:center;padding-left:0;padding-right:0;border:none;background:rgb(253,253,255)">
