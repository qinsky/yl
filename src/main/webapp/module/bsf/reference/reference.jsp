...
<html>
	<head>
		 ...
		 <script type="text/javascript" src="${ctxPath}/module/bsf/reference/reference_billTemplate.js?v=<%=com.youlun.baseframework.util.AppUtils.getResLastTimeStr("/module/bsf/reference/reference_billTemplate.js")%>"></script> 
		 <script type="text/javascript" src="${ctxPath}/module/bsf/reference/reference.js?v=<%=com.youlun.baseframework.util.AppUtils.getResLastTimeStr("/module/bsf/reference/reference.js")%>"></script>
		 <title></title>
	</head>
	<body>
