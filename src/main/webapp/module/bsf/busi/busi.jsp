...
<html>
	<head>
		 ...
		 <script type="text/javascript" src="${ctxPath}/module/bsf/busi/busi_billTemplate.js?<%=System.currentTimeMillis()%>"></script> 
		 <script type="text/javascript" src="${ctxPath}/module/bsf/busi/busi.js?<%=System.currentTimeMillis()%>"></script>
		 <title></title>
	</head>
	<body>
		 <div id="cc" class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'west',split:true" title="组织结构" style="width:300px;">
