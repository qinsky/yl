...
<html>
	<head>
		 ...
		 <script type="text/javascript" src="${ctxPath}/module/bsf/defaultTree/default.js?v=<%=com.youlun.baseframework.util.AppUtils.getResLastTimeStr("/module/bsf/defaultTree/default.js")%>"></script>
		 <title></title>
	</head>
	<body>
