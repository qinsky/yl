...
<html>
	<head>
		 ...
		 <script type="text/javascript" src="${ctxPath}/module/bsf/user/user_billTemplate.js?v=<%=com.youlun.baseframework.util.AppUtils.getResLastTimeStr("/module/bsf/user/user_billTemplate.js")%>"></script> 
		 <script type="text/javascript" src="${ctxPath}/module/bsf/user/user.js?v=<%=com.youlun.baseframework.util.AppUtils.getResLastTimeStr("/module/bsf/user/user.js")%>"></script>
		 <title></title>
	</head>
	<body>
