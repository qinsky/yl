...
public class CsttypeReference extends AbstractReference{
	...
	public JSONArray getData() {
		// TODO Auto-generated method stub
		return DBOperator.query("select * from ul_crm_csttype where df!='Y'");
	}
	...
	public JSONArray getRefText() {
		...
		StringBuffer sql = new StringBuffer("select id ,name  from ul_crm_csttype where id in(");
