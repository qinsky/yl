...
public class MenuReference extends AbstractReference{
	...
	public JSONArray getData() {
		// TODO Auto-generated method stub
		return DBOperator.query("select * from ul_bsf_menu where df!='Y'");
	}
	...
	public JSONArray getRefText() {
		...
		StringBuffer sql = new StringBuffer("select id ,name  from ul_bsf_menu where id in(");
